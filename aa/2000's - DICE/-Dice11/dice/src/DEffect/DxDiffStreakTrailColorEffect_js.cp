// --------------------------------------------------------------------------------
//
// DiffStreakTrailColorEffect -- colorize the changes.
//
...
#include "DxDiffStreakTrailColorEffect.h"
...
#define DS_TYPE		DxDiffStreakTrailColorEffect
#define DS_CLASS_NAME "DiffStreakTrailColorEffect"
...
// --------------------------------------------------------------------------------
JSObject * ds_DiffStreakTrailColorEffect_InitClass(JSContext *cx, JSObject *obj)
{
    JSObject *proto;
